...
class PagBankApp {
    ...
    setupExitIntent() {
        ...
        document.addEventListener('mouseleave', (e) => {
            if (e.clientY <= 0 && !hasShownExitIntent && !this.utils.isMobile()) {
    ...
    showExitIntentPopup() {
        // Only for desktop/tablet as per requirements
            ...
            <div class="popup-overlay">
                <div class="popup-content">
                    ...
                    <div class="popup-header">
                        ...
                        <p>Transforme seu negócio com as melhores maquininhas do mercado</p>
                    </div>
                    <div class="popup-benefits">
                        <div class="benefit">
                            <i class="fas fa-check-circle"></i>
                            <span>Taxa a partir de 0,99%</span>
                        </div>
                        <div class="benefit">
                            <i class="fas fa-check-circle"></i>
                            <span>Receba em 1 dia útil</span>
                        </div>
                        <div class="benefit">
                            <i class="fas fa-check-circle"></i>
                    ...
                    <div class="popup-cta">
                        <a href="${this.config.affiliateLinks.maquininhas}" class="btn btn-primary btn-lg" target="_blank">
        ...
        // Event listeners
        const closePopup = () => {
            popup.style.animation = 'popupFadeIn 0.3s ease-in reverse';
        ...
        // Track popup show
        this.trackEvent('popup', 'exit_intent_shown');
    }
